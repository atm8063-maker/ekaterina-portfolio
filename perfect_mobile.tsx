      ...
      <section className="relative w-full overflow-hidden bg-white border-b border-[#111111]/10">
        <div className="relative w-full max-w-[1920px] mx-auto min-h-[500px] lg:min-h-[600px] flex items-center">
          ...
          <div className="absolute inset-0 w-full h-full pointer-events-none">
            <div className="absolute right-0 top-0 w-full sm:w-[80%] md:w-[70%] lg:w-[60%] xl:w-[55%] h-full translate-x-[115px] sm:translate-x-0">
              <Image 
          ...
          {/* Текстовый блок */}
          <div className="relative z-10 w-full px-6 sm:px-12 lg:px-[8%] xl:px-[12%] py-16 lg:py-0 mt-[120px] sm:mt-0">
            <div className="max-w-[260px] sm:max-w-sm md:max-w-md lg:max-w-lg">
              <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black uppercase text-[#111111] font-montserrat mb-4 sm:mb-6 leading-[1.05] tracking-tight relative -top-8 sm:top-0">
                ИСКУССТВО <span className="text-[#0D9488]">В</span><br />
                <span className="text-[#0D9488]">ПРОСТРАНСТВЕ</span>
              </h2>
              
              <p className="text-[#444444] text-sm sm:text-base lg:text-lg font-medium leading-[1.6] sm:leading-relaxed font-inter">
                Здесь будет располагаться текст о том, как картина дополняет интерьер, или о философии создания именно этой работы. Выбеленное пространство слева идеально подходит для акцентного рассказа.
              </p>
            </div>
          </div>
        </div>
