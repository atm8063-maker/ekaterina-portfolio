export function StubSection({ id, title, desc }: { id: string, title: string, desc: string }) {
  return (
    <section id={id} className="py-20 border-b border-white/10 bg-[#111111] flex flex-col items-center justify-center text-center relative overflow-hidden scroll-mt-4">
