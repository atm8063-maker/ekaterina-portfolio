        ...
        <div className="grid lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <div className="space-y-4 text-white/70 text-base sm:text-lg leading-relaxed font-inter">
              ...
              <p>
                Также я <strong className="text-[#14F1D9] font-semibold">спроектировала специализированный защитный короб для опила смолы</strong>, защищающий мастера от пыли — производитель пустил мою разработку в серийное производство.
              </p>
            </div>
