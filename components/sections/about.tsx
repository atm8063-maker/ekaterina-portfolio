...
export default function About() {
  ...
  return (
    <section id="about" className="relative overflow-hidden bg-[#111111] text-white lg:min-h-[100svh] lg:h-[100svh] pt-16 pb-14 lg:py-0 px-5 sm:px-10 lg:px-12 xl:px-16 flex items-center justify-center">
      ...
      <div className="w-full max-w-[1440px] mx-auto flex flex-col lg:flex-row items-center justify-center lg:justify-between h-full relative z-20 gap-6 lg:gap-0">
