...
const artworksData: Artwork[] = [
  ...
  // 2. Папка 1: Deep rest (теперь объект 02)
  {
    ...
    concept: 'Исследование эмоционального замирания, поиска тишины и пограничного состояния между исцеляющим покоем и депрессией.',
    fullConcept: [
      {
        heading: 'Оптическая иллюзия покоя',
        text: 'Застывшая толща смолы создает обманчивое ощущение прозрачной безмятежности, под которой скрыты слои необработанной глины и гипса.',
      },
      {
      ...
      },
      {
        ...
        text: 'Глянцевый монолит сверху против шероховатых, разорванных текстур внутри символизирует внешний фасад спокойствия при внутреннем разломе.',
      },
      {
        heading: 'Окаменение времени',
        text: 'Силиконовые формы и пигменты фиксируют миг замирания перед новым вдохом в эпоху непрерывного информационного шума.',
      },
    ],
  ...
  // 3. Папка 3: Последняя капля (оригинальное фото 1280x758 из папки)
  {
    ...
    concept: 'Метафора предельного накопления напряжения и точки невозврата, когда единичный импульс разрушает хрупкое равновесие.',
    fullConcept: [
      {
      ...
      },
      {
        ...
        text: 'Форма капли смолы, балансирующая на грани срыва, как символ критической массы подавленных эмоций и невысказанных слов.',
      },
      {
        heading: 'Силиконовая эластичность',
        text: 'Материал сопротивляется деформации до последнего предела, наглядно показывая грань между человеческой выдержкой и неминуемым взрывом.',
      },
    ],
  ...
  // 4. Папка 4: Бензиновая радуга
  {
    ...
    concept: 'Токсичная эстетика урбанизма и хрупкость природы: притягательная красота загрязнения, скрывающая разрушение.',
    fullConcept: [
      {
        heading: 'Иллюзия цвета на ядовитой плёнке',
        text: 'Радужные переливы бензиновой пленки притягивают взгляд эстетикой цвета, маскируя следы экологического и внутреннего бедствия.',
      },
      {
        heading: 'Окаменелая органика',
      ...
      },
      {
        ...
        text: 'Плотные минеральные текстуры сталкиваются с текучими флуоресцентными красителями, визуализируя противостояние цивилизации и биосферы.',
      },
    ],
  ...
  // 5. Папка 5: Пусть танцуют лебеди (только 1 фото, без руки)
  {
    ...
    concept: 'Историческая аллюзия на балет «Лебединое озеро» по ТВ во время кризисов и переворотов — символ тревожного ожидания и занавеса.',
    fullConcept: [
      {
        heading: 'Терновый шип вместо грации',
        text: 'Реальная колючая ветка терновника прорывает чистый бумажный лист, превращая сказочный танец в болезненный укол реальности.',
      },
      {
        heading: 'Пустота ватмана',
        text: 'Монохромный белый фон подчёркивает оглушающую тишину и информационный вакуум официальной повестки.',
      },
      {
  ...
  // 6. Папка 6: И?
  {
    ...
    concept: 'Ироничный диалог с обесцениванием, цинизмом и усталостью от бесконечных вопросов без ответов.',
    fullConcept: [
      {
        heading: 'Скепсис как защита',
        text: 'Односложный провокационный вопрос «И?» разрушает пафос и обнажает экзистенциальную растерянность современного человека.',
      },
      {
        heading: 'Энергия стрит-арта',
        text: 'Графика маркерами и грубый акрил на холсте переносят язык уличных протестных тегов в пространство концептуальной галереи.',
      },
      {
        heading: 'Текстурный слом',
        text: 'Слоистые мазки создают ощущение наслоения чужих мнений, сквозь которые проступает равнодушный главный вопрос.',
      },
    ],
  ...
  // 7. Папка 7: Красная серия
  {
    ...
    concept: 'Экспрессивное исследование витальности, агрессии, боли и страсти через тотальный красный цвет.',
    fullConcept: [
      {
        heading: 'Красный как сигнал тревоги и жизни',
        text: 'Доминирующий спектр активирует первобытные инстинкты — от опасности до неукротимой энергии созидания.',
      },
      {
        heading: 'Полиптих состояний',
        text: 'Каждый из 6 объектов исследует отдельную грань эмоции — от глянцевого смоляного среза до глубокой рельефной раны.',
      },
      {
    ...
    materials: 'Смешанные медиа · Полиптих из 6 объектов',
    year: '2024',
    media: [
      {
        type: 'image',
