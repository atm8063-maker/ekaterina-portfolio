...
export function ArtSpace() {
  return (
    <section id="art-space" className="relative w-full overflow-hidden bg-white border-b border-[#111111]/10 pt-8 sm:pt-10 scroll-mt-20">
      
      {/* DESKTOP LAYOUT (>= md) */}
      <div className="hidden md:flex relative w-full max-w-[1440px] mx-auto min-h-[580px] lg:min-h-[600px] items-center">
        <div className="absolute inset-0 w-full h-full pointer-events-none">
          <div className="absolute right-0 top-0 bottom-0 w-[65%] lg:w-[60%] xl:w-[55%]">
            <Image 
        ...
        <div className="relative z-10 w-full px-6 sm:px-10 lg:px-12 py-16">
          <div className="max-w-md lg:max-w-lg">
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-black uppercase text-[#111111] font-montserrat mb-6 leading-[1.05] tracking-tight">
              ГАЛЕРЕЯ <span className="text-[#0D9488]">РАБОТ</span>
            </h2>
            
            <p className="text-[#444444] text-base lg:text-lg font-medium leading-relaxed font-inter">
      ...
      {/* MOBILE LAYOUT (< md) */}
      <div className="md:hidden flex flex-col w-full px-6 pt-4 pb-8">
        <h2 className="text-3xl font-black uppercase text-[#111111] font-montserrat mb-4 leading-tight tracking-tight">
          ГАЛЕРЕЯ <span className="text-[#0D9488]">РАБОТ</span>
        </h2>
        
        <p className="text-[#444444] text-sm font-medium leading-relaxed font-inter mb-6">
          Основной материал в моём творчестве — это эпоксидная смола, которая отлично подходит не только для декоративных акцентных работ, но и для создания каустических эффектов, возникающих при преломлении солнечных лучей. Сочетание света, цвета и разнообразных текстур позволяет расширять границы условного &quot;холста&quot; и &quot;выходить за рамки&quot; во всех смыслах.
        </p>

        <div className="relative w-full aspect-[4/3] rounded-lg overflow-hidden shadow-xl border border-black/10">
          <Image 
            src="/art-gallery/photo_2930@31-07-2026_17-46-03.jpg" 
            alt="Искусство в пространстве" 
            fill
