    ...
    <div className="min-h-screen bg-[#111111] text-[#E0E0E0] selection:bg-[#14F1D9] selection:text-black">
      ...
      <header className="sticky top-0 z-40 bg-[#111111]/90 backdrop-blur-md border-b border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-xs text-white/50 font-mono">{meta.year}</span>
          </div>
        </div>
      </header>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-28">
        ...
        <section className="pt-12 border-t border-white/10">
          <div className="bg-gradient-to-r from-[#1A1A1A] via-[#1c2a38] to-[#1A1A1A] border border-white/10 rounded-2xl p-8 flex flex-col sm:flex-row items-center justify-between gap-6 hover:border-[#14F1D9]/50 transition-all">
            <div>
              ...
              <div className="text-xl sm:text-2xl font-black font-montserrat uppercase text-white">
                Shop 4.0: Магазин электроники
              </div>
              <p className="text-xs text-white/60 font-sans mt-1">
                UX-исследования, аналитика конверсий, мобильный флоу чекаута и дизайн-система
              </p>
            </div>
            <Link
              href="/cases/09-mockup-electronics"
