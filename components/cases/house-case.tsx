...
export function HouseCase() {
  ...
  return (
    <div className="min-h-screen bg-[#111111] text-white selection:bg-[#14F1D9] selection:text-[#111111]">
      ...
      {/* 2. STICKY NAVIGATION (Direct anchors, zero confusing tabs) */}
      ...
      <main className="container mx-auto px-4 md:px-8 py-10 space-y-20">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-8 border-b border-white/10 pb-4 relative z-10">
              <div>
                ...
                <p className="text-xs text-white/60 mt-1 font-sans">
                  Объёмно-пространственные разрезы дома в маркерной акварели: 1-й и 2-й этажи наглядно рядом на одном экране
                </p>
              </div>
              <div className="text-xs text-white/40 font-sans hidden sm:block">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start relative z-10">
              ...
              <div className="bg-[#141414] border border-white/15 p-4 sm:p-6 shadow-xl flex flex-col">
                <div className="flex items-center justify-between pb-3 mb-4 border-b border-white/10">
                  <div>
                    <span className="text-[10px] font-bold uppercase text-[#14F1D9] font-montserrat tracking-widest block mb-0.5">
                      Общественное ядро дома
                    </span>
                    <h3 className="text-base sm:text-lg font-black uppercase text-white font-montserrat">
                  ...
                  <button
                    ...
                    className="text-[10px] text-white/60 hover:text-[#14F1D9] font-sans flex items-center gap-1 transition-colors"
                  >
                ...
                <div className="relative aspect-square w-full bg-black/40 border border-white/10 overflow-hidden mb-5 group">
                  <Image
                    src={FLOOR_SKETCHES[1].imageSrc}
                    ...
                    return (
                      ...
                      >
                        <button
                          ...
                          className={`relative flex items-center justify-center w-6 h-6 sm:w-7 sm:h-7 rounded-full font-montserrat font-black text-xs transition-all duration-300 ${
                            isActive
                ...
                <div className="space-y-2">
                  <div className="text-[11px] font-bold uppercase tracking-wider text-white/70 font-montserrat mb-2 flex items-center gap-1.5">
                    <Flame className="w-3 h-3 text-[#14F1D9]" />
                    ...
                    return (
                      <div
                        ...
                        className={`p-2.5 border transition-all cursor-pointer ${
                          isActive
                            ? "bg-[#14F1D9]/10 border-[#14F1D9] shadow-[0_0_12px_rgba(20,241,217,0.15)] translate-x-1"
                            : "bg-black/30 border-white/5 hover:border-white/20 hover:bg-white/5"
                        }`}
                      >
                        <div className="flex items-start gap-2.5">
                          <span
                            className={`flex items-center justify-center w-5 h-5 rounded-full text-[10px] font-black shrink-0 font-montserrat ${
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex items-center justify-between gap-2">
                              ...
                              <span className="text-[9px] font-bold uppercase tracking-wider text-[#14F1D9] font-montserrat shrink-0">
                                {c.tag}
                              </span>
                            </div>
                            <p className="text-[11px] text-white/65 font-sans mt-0.5 leading-relaxed">
                              {c.desc}
                            </p>
                          </div>
                        </div>
          ...
          <div className="bg-[#181818] border border-white/15 p-6 md:p-8 shadow-2xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-stretch mb-8">
              ...
              <div
                ...
                className="bg-[#141414] border border-white/20 hover:border-[#14F1D9] p-3 sm:p-4 cursor-pointer group transition-all shadow-xl flex flex-col justify-between"
              >
                <div className="flex items-center justify-between px-1 py-1 mb-2 border-b border-white/10">
                  <div>
                    <span className="text-xs font-bold text-white font-montserrat uppercase tracking-wider block">
                      Стили и фактуры
                    </span>
                    <span className="text-[10px] text-white/50 font-sans">Скандинавский минимализм, дерево и уют</span>
                  </div>
                  <span className="text-[10px] text-white/50 font-sans flex items-center gap-1 group-hover:text-[#14F1D9] shrink-0">
              ...
              <div
                ...
                className="bg-[#141414] border border-[#14F1D9]/30 hover:border-[#14F1D9] p-3 sm:p-4 cursor-pointer group transition-all shadow-xl flex flex-col justify-between"
              >
                <div className="flex items-center justify-between px-1 py-1 mb-2 border-b border-white/10">
                  <div>
                    <span className="text-xs font-bold text-[#14F1D9] font-montserrat uppercase tracking-wider block">
                      Цветовая палитра
                    </span>
                    <span className="text-[10px] text-white/50 font-sans">Акцентная бирюза, дуб, серый и белый</span>
                  </div>
                  <span className="text-[10px] text-white/50 font-sans flex items-center gap-1 group-hover:text-[#14F1D9] shrink-0">
                    <Maximize2 className="w-3 h-3" /> Увеличить
                  </span>
        ...
        {/* SECTION 3: 3D PLANOPLAN & FUNCTIONAL ZONING (Both floors side-by-side) */}
        <section id="planoplan" className="scroll-mt-28 space-y-8">
          <div className="bg-[#181818] border border-white/15 p-6 md:p-8 shadow-2xl">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6 border-b border-white/10 pb-4">
              <div>
                <h2 className="text-xl sm:text-2xl font-black uppercase text-white font-montserrat">
                  3D-Моделирование в Planoplan &amp; Функциональное Зонирование
                </h2>
                <p className="text-xs text-white/60 mt-1 font-sans">
                  Виртуальное моделирование дома, видовые оси, инсоляция и зонирование (из папки «Рендеры в планоплане»)
                </p>
              </div>
              <div className="text-xs text-white/50 font-sans">
                Кликните по планшету для полноэкранного зума
            ...
            {/* Dual Column Zones (Floor 1 & Floor 2 side-by-side, NO switches) */}
            <div className="bg-[#141414] border border-white/10 p-6">
              <h3 className="text-sm font-bold uppercase tracking-wider text-white font-montserrat mb-6 flex items-center gap-2">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between pb-2 border-b border-white/10">
                    <span className="text-xs font-black uppercase text-[#14F1D9] font-montserrat tracking-wider">
                      1 Этаж: Зоны первого этажа
                    </span>
                    <span className="text-[10px] text-white/50 font-sans">
                      {floor1Data.zones.length} функциональных узла
                    </span>
                  </div>
                    ...
                    {floor1Data.zones.map((zone) => (
                      ...
                      >
                        <div className="flex items-center justify-between mb-1">
                          <h4 className="text-xs font-bold text-white font-montserrat truncate">{zone.name}</h4>
                          {zone.area && (
                            <span className="text-[11px] font-montserrat font-bold text-[#14F1D9] shrink-0 ml-1">{zone.area}</span>
                          )}
                        </div>
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between pb-2 border-b border-white/10">
                    <span className="text-xs font-black uppercase text-[#14F1D9] font-montserrat tracking-wider">
                      2 Этаж: Зоны второго этажа
                    </span>
                    <span className="text-[10px] text-white/50 font-sans">
                      {floor2Data.zones.length} функциональных узла
                    </span>
                  </div>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        ...
        {/* SECTION 5: LIGHTING & ENGINEERING */}
